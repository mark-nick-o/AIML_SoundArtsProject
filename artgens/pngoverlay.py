...
class PNGOverlay():
    ...
    #def _transparent(self, src_bgra):
    #    ps = np.array(src_bgra)
        #r, g, b, a = np.rollaxis(x, axis = -1)
    #    if ps[..., 0] >= 230 and ps[..., 1] >= 230 and ps[..., 2] >= 230:
    #        ps[..., 3] = 0                                              # set A channel to 0 is transparent 
    #    src_bgra = np.dstack([ps[..., 0], ps[..., 1], ps[..., 2], ps[..., 3]])
...
if __name__ == '__main__':
    ...
    #Instance generation
    happy = PNGOverlay('/mnt/c/linuxmirror/pigTra.png')
...
#    cv2.imshow('dst',dst)
    ...
    dst = cv2.imread('/mnt/c/linuxmirror/art3.jpg') #background
    dst = cv2.resize(dst, dsize=None, fx=0.8, fy=0.8)
    test.rotate(60)
