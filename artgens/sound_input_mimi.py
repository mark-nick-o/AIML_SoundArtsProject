...
#
    if os.path.isfile('mimi_auth.json') == False:
...
#
        ...
        #try:
            ...
            #curl = pycurl.Curl()
            #curl.setopt(pycurl.URL, 'https://auth.mimi.fd.ai/v2/token')
            #curl.setopt(pycurl.CUSTOMREQUEST, 'POST')
            #field_data = restOfurl
            #curl.setopt(pycurl.POSTFIELDS, field_data)
            #reponse = curl.perform()
            #print(urlreq)
...
#    
        ...
        cmd = '/home/mark/pics/mimi_speak2txt.sh ' + sys.argv[2] + ' ' + MIMI_PROCESS
        print(cmd)
        f = os.popen(cmd)
        response = f.read()
        print("========= response ===========")
...
#    
        ...
        cmd = '/home/mark/pics/mimi_txt2speak.sh ' + sys.argv[2]
        f = os.popen(cmd)
        response = f.read()
        #
